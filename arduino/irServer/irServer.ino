...
void loop() {
  ...
  if (irrecv.decode(&results) && !latch) {
    ...
    Serial.println("Recorded signal of length " + String(rawdataLength));
    for(int i=1; i < 100; i++){
  ...
  Serial.println("Replaying signal of length " + String(rawdataLength) + " ...");
